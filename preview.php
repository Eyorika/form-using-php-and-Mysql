  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="https://i.pinimg.com/564x/9a/39/65/9a3965aa0aca150ef0edde54e7a5b82d.jpg" class="img-fluid">
          </div>
           <div class="col">
              <div class="main-heading">INSPIRE TECH HUB</div>
     <p class="sub-heading"> Ministry of Inovation. CIN. No. MD75200CP2921NPL TAN. MDPP90708E</p>
      <div class="address"> Hed.Office: Addis Ababa , Bole - 1023  Register office: Addis Ababa  1000
</div>
         <p class="email"> Email: inspiretechhub@info.com , Website: www.inspiretechhub.com</p>
          </div>
          <div class="col-sm-12">
            <hr class="hrcls"> 
          </div>
